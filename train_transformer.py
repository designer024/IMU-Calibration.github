...
def main(args):
    ...
    dataset_train = IMUDataset(
        ...
        input_length=args.input_length, overlap=args.overlap, shift=1
    )
    ...
    # init model
    model = IMUModel(encoder_hidden_size=args.hidden_size, decoder_hidden_size=args.hidden_size,
            encoder_layers=args.num_layers, decoder_layers=args.num_layers,
            encoder_max_length=args.input_length, decoder_max_length=args.input_length,
            vocab_size=args.num_joints*args.in_features, 
            dropout=args.dropout).to(args.device)
    model_eval = IMUModel(encoder_hidden_size=args.hidden_size, decoder_hidden_size=args.hidden_size,
            encoder_layers=args.num_layers, decoder_layers=args.num_layers,
            encoder_max_length=args.input_length, decoder_max_length=args.input_length,
            vocab_size=args.num_joints*args.in_features, 
            dropout=args.dropout).to(args.device)
